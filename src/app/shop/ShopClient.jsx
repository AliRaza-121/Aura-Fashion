...
function ShopContent({ initialProducts = [] }) {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return result;
  }, [initialProducts, selectedCategories, selectedSizes, selectedColors, priceRange, sortBy, searchParams]);
...
export default function ShopClient({ initialProducts }) {
  return (
    <Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><div className="text-sm font-bold tracking-widest uppercase text-gray-400">Loading Filters...</div></div>}>
